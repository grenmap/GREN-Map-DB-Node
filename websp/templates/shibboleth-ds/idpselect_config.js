...
function IdPSelectUIParms(){
    ...
    this.myEntityID = "https://__MAP_HOST_NAME__/shibboleth";          // If non null then this string must match the string provided in the DS parms
    this.redirectAllow = [ "^https:\/\/__MAP_HOST_NAME_REGEX__:__MAP_HOST_PORT__\/Shibboleth\.sso\/Login.*$" ];
    //this.redirectAllow = [ "^.*$" ];

    this.alwaysShow = true;          // If true, this will show results as soon as you start typing
    this.dataSource = '/Shibboleth.sso/DiscoFeed';   // Where to get the data from
    this.defaultLanguage = 'en';     // Language to use if the browser local doesnt have a bundle
    this.defaultLogo = 'institution.png';  // Replace with your own logo
    ...
    this.helpURL = 'https://wiki.shibboleth.net/confluence/display/DEV/EDSDetails'; //'https://wiki.shibboleth.net/confluence/display/SHIB2/DSRoadmap';
    ...
    this.langBundles = {
        'en': {
            ...
            'idpEntry.label': 'In order to log into the GREN map please enter your organization\'s name:',
            'idpEntry.NoPreferred.label': 'Enter your organization\'s name',
            'idpList.label': 'In order to log into the GREN map please enter your organization\'s name:',
        ...
        'fr': {
            'fatal.divMissing': 'Impossible de retrouver "insertAtDiv" dans le HTML',
            'fatal.noXMLHttpRequest': 'Le navigateur n\'accepte pas "XMLHttpRequest", impossible de récupérer les données du fournisseur d\'identités',
            'fatal.wrongProtocol' : 'La politique fournie n\'est pas "urn:oasis:names:tc:SAML:profiles:SSO:idpdiscovery-protocol:single"',
            'fatal.wrongEntityId' : 'Le paramètre "entityId" du fournisseur de services ne correspond pas à celui qui a été configuré',
            'fatal.noData' : 'Aucune métadonnée téléchargée',
            'fatal.loadFailed': 'Impossible de télécharger les métadonnées de',
            'fatal.noparms' : 'Paramètres de la séance de découverte et paramètre "defaultReturn" non configurés',
            'fatal.noReturnURL' : 'Paramètres de la séance de découverte et paramètre "defaultReturn" non configurés',
            'fatal.badProtocol' : 'La requête doit commencer par https:// ou http://',
            'fatal.badReturnString' : "Return parameter is not whitelisted",
            'idpPreferred.label': 'Utiliser un des choix proposés :',
            'idpEntry.label': 'Pour accéder au GREN map, vous devez saisir le nom de l\'organisation.',
            'idpEntry.NoPreferred.label': 'Saisissez le nom de l\'organisation',
            'idpList.label': 'Pour accéder au GREN map, vous devez saisir le nom de l\'organisation.',
            'idpList.NoPreferred.label': 'Sélectionnez votre organisation dans la liste',
            'idpList.defaultOptionLabel': 'Veuillez sélectionner votre organisation…',
            'idpList.showList' : 'Me permettre de choisir dans une liste',
            'idpList.showSearch' : 'Me permettre de spécifier le site',
            'submitButton.label': 'Continuer',
            'helpText': 'Aide',
            'defaultLogoAlt' : 'Logo par défaut (DefaultLogo)'
        },
    };
