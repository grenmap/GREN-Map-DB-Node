...
@translated_docstring(gettext_noop(
    """
    Permanently deletes matched Links' properties.
    """
))
class DeleteLinkProperty (BaseActionType):
    name = gettext_noop('Delete Link Property')
    ...
    def apply(self, link):
        ...
        matching value) from the given Link.
        """
        ...
        if property_value is not None:
            ...
            deleted_property = Property.objects.filter(property_for=link, name=property_name)
