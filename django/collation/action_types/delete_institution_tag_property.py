...
@translated_docstring(gettext_noop(
    """
    Permanently deletes matched Institutions' tag properties.
    """
))
class DeleteInstitutionTagProperty (BaseActionType):
    name = gettext_noop('Delete Institution Tag Property')
    ...
    def apply(self, institution):
        ...
        tag value from the given Institution.
        """
