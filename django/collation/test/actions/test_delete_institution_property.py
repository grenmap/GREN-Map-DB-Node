...
DELETE_INSTITUTION_PROPERTY_CLASS_NAME = 'DeleteInstitutionProperty'
DELETE_INST_PROPERTY_ACTION_TYPE_NAME = 'Delete Institution Property'


@pytest.mark.django_db
class TestDeleteInstitutionProperty:
    ...
    def two_nodes_and_links(self):
        ...
        Populates the database with a few GRENML records for testing:
            ...
            - two nodes,
            - two links, and
            - one property in the institution
        """
        ...
        institution.property('institutionproperty', value='Test')
    ...
    def property_name_with_capital_letters(self):
        ...
        institution.property('InstitutionPropertyUPPERCASE', value='Test')

    @pytest.fixture
    def institution_with_three_properties(self):
        """
        Populates the database with a few GRENML records for testing:
            - one institution,
            - three property in the institution
        """
        institution = grenml.Institution.objects.create(
            grenml_id='institution-id',
            name='TestREN',
        ...
        institution.property('institutionproperty_1', value='Value_1')
        institution.property('institutionproperty_2', value='Value_2')
        institution.property('institutionproperty_3', value='Value_3')
    ...
    def institution_with_ten_properties_five_same_name(self):
        ...
        Populates the database with a few GRENML records for testing:
            - one institution,
            - ten properties in the institution,
        ...
        grenml.Property.objects.create(
            name='institutionproperty_same_name',
            value='Value_1',
    ...
    def test_build_rule(self, load_match_and_action_types, two_nodes_and_links, simple_rule):
        ...
        """
        delete_institution_prop_action_type = ActionType.objects.get(
            class_name=DELETE_INSTITUTION_PROPERTY_CLASS_NAME,
        )
        delete_inst_prop_action = Action.objects.create(
            rule=simple_rule,
            action_type=delete_institution_prop_action_type,
        )
        assert delete_inst_prop_action.action_type.name == DELETE_INST_PROPERTY_ACTION_TYPE_NAME
    ...
    def test_affected_element_counts(
        ...
        delete_institution_prop_action = Action.objects.create(
            rule=simple_rule,
            action_type=delete_institution_prop_action_type
        )

        ActionInfo.objects.create(
            action=delete_institution_prop_action,
            key='name',
            value='institutionproperty'
        )
    ...
    def test_action_value_with_uppercase_letters(
        ...
        target_property = grenml.Property.objects.all().filter(
            property_for=target_inst, name='InstitutionProperty', value='Test')
    ...
    def test_property_name_with_uppercase_letters(
        ...
        ActionInfo.objects.create(
            action=delete_institution_prop_action,
            key='name',
            value='InstitutionPropertyUPPERCASE'
        )
        ...
        target_property = grenml.Property.objects.all().filter(
            property_for=target_inst, name='InstitutionPropertyUPPERCASE', value='Test')
    ...
    def test_name_value_as_criteria(
        self,
        load_match_and_action_types,
        institution_with_three_properties,
        simple_rule
    ):
        """
        Confirm the apply method returns the correct count for affected
        ...
        target_property = grenml.Property.objects.all().filter(
            property_for=target_inst, name='institutionproperty_2', value='Value_2')
    ...
    def test_name_value_as_criteria_same_names(
        ...
        ActionInfo.objects.create(
            action=delete_institution_prop_action,
            key='name',
            value='institutionproperty_same_name'
        )
        ...
        target_property = grenml.Property.objects.all().filter(
            property_for=target_inst, name='institutionproperty_same_name', value='Value_2')
    ...
    def test_same_names(
        ...
        target_property = grenml.Property.objects.all().filter(
            property_for=target_inst, name='institutionproperty_same_name')
